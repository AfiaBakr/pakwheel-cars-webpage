    ...
    return(
        <div className="bg-slate-100">
            <div className="text-center">
                <h1 className="text-5xl py-8 "><b><u>Suzuki Swift 2024 Price in Pakistan, Images, Reviews & <br/>Specs.</u></b></h1>
            </div>

            <div>
            <div className="flex justify-center">           
                <img className="ring-2 ring-slate-800 rounded-tl-xl rounded-bl-xl" src="./suzukiswift/suzukiswift1.jpg"
                alt="Suzuki Swift"
                width={450}
                height={300}/>
            
            <div>
                <img className="ring-2 ring-slate-800 mb-1 rounded-tr-xl" src="./suzukiswift/suzukiswift2.jpg"
                alt="Suzuki Swift"
                width={150}
                height={100}/>

                <img className="ring-2 ring-slate-800" src="./suzukiswift/suzukiswift3.jpg"
                alt="Suzuki Swift"
                width={150}
                height={100}/>

                <img className="ring-2 ring-slate-800 mt-1 rounded-br-xl" src="./suzukiswift/suzukiswift4.jpg"
                alt="Suzuki Swift"
                width={150}
                height={100}/>
            </div>
